...
<template>
  <div class="l-time-dim-tab l-centered-vertical-tab">
    ...
    <div>
      ...
      <b style="color:var(--color-eternity)">{{ format(costIncreases[1]) }}</b> Eternity Points, and costs increase much faster after 
      <b style="color:var(--color-eternity)">{{ format(costIncreases[2]) }}</b> Eternity Points.
      <br>
