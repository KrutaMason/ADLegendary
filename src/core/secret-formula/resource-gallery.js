...
export const resourceGallery = {
   ...
   */
    ...
    },
    {
        ...
        Dimension Boosts are the first prestige mechanic, meaning that preforming them resets your progress.`,
    },
    {
        id: 3,
    ...
    },
    {
        ...
        This variant contains the remnants of the antimatter you have harvested from your multidimensional progress.<br><br>
    ...
    },
    {
        ...
        and the main currency of the first main prestige layer; Infinity.
    ...
    },
    {
        ...
        ${PlayerProgress.realityUnlocked() || PlayerProgress.eternityUnlocked() ? 
            ...
            a fraction of them can be spared as "Banked Infinities", which work the same as the regular ones.`:``}
        ${PlayerProgress.realityUnlocked() ? 
            `<br><br>With <b><i>The Boundless Flow</i></b>, you can gain a tenth of 
    ...
    },
    {
        ...
        related: [13],
        info: () => `With the introduction of a new type of Dimensions, 
       ...
       : "1st Infinity Dimension"}.<br><br>
        ...
        Unlike Antimatter, Infinity Power can't be spent, but you lose them after you infinity.`,
    },
    {
        id: 9,
        name: 'Replicanti',
        ...
        you can make the Replicanti input more efficient, adding more effects.`:``}`,
    },
    {
        id: 10,
        ...
        Replicanti galaxies contain the sacrificed replicanti that have eventually turned into stars, dust, etc.`,
    },
    {
        id: 11,
    ...
    },
    {
        ...
        related: [6,19,35],
        info: () => `Similar to Infinities, you get "Eternities" from going eternal and 
    ...
    },
    {
        ...
        How many free Tickspeed Upgrades you get depends on how much Time Shards you have.`,
    },
    {
        id: 14,
        name: 'Time Theorems',
        ...
        There are also studies that unlock the Eternity challenges, which have a secondary requirement. 
        ${PlayerProgress.realityUnlocked() ? 
            `Having the <b><i>Olympic Negligibility</i></b> Perk removes that 
            requirement.`:``}`,
    },
    {
        id: 15,
        ...
        ${PlayerProgress.realityUnlocked() ? 
            `<br><br> The <b><i>Paradoxical Assurance</i></b> Perks allow purchases 
            from the 3rd rebuyable Dilation Upgrade to give more Tachyons.`:``}
        ${Ra.pets.teresa.isCapped?`Maximizing Teresa's memories allows 
    ...
    },
    {
        ...
        the reality-bending upgrades and the Black Hole that can make time pass faster.<br><br>
        ${Teresa.isUnlocked?`With the introduction of Teresa, you can  
            pour your Reality Machines into the container for higher gains 
    ...
    },
    {
        ...
        related: [6,12,35],
        info: () => `Similar to the first two layers' resets, you get a "Reality" for making a new one. 
    ...
    },
    {
        ...
        which means you have to figure out which Glyph is best to 
        choose every time you unlock Reality.<br><br>
    ...
    },
    {
        ...
        Faster game speed also benefits upgrade effects that base on how long you have existed.`,
    },
    {
        id: 24,
        name: 'Relic Shards',
        ...
        In exchange, you get mechanics that improve your sortability on Glyphs.`,
    },
    {
        id: 25,
        name: 'Stored Time',
    ...
    },
    {
        ...
        At the astronomical cost of infinity points, these things let you purchase more infinity dimensions for higher multipliers. <br><br>
    ...
    },
    {
        ...
        <br><br> Space Theorems can be used to purchase the normally locked studies
    ...
    },
    {
        ...
        ${Ra.remembrance.isUnlocked?`With Remembrance, Ra can focus 
            harder on recollecting a celestial at a price of the other 
            ones being less relevant. This makes Memory Chunk production vary.`:","}`,
    },
    {
        id: 29,
        name: 'Memories',
        ...
        Milestones for celestial levels vary from a small boost to unlocking new mechanics.`,
    },
    {
        id: 30,
        ...
        The lower resources can be transformed into a higher tier, exchanging effects.<br><br>
        ${Ra.pets.effarig.isCapped?`At Effarig level 25, you can use all 
            6 alchemy resources of the 4th tier to create the 
            Philosopher's Glyph; Reality Glyphs`:""}`,
    },
    {
        id: 31,
        ...
        powerful set of Imaginary upgrades, ranging from boosts to unlocking the final, but powerful 2 Celestials.
    ...
    },
    {
        ...
        The Dark Energy production are independent from your dimension amounts and multipliers.`,
    },
    {
        id: 35,
        name: 'Singularity',
        ...
        related: [6,12,19,34],
        info: () => `Singularities are a byproduct of condensing Dark Energy, having infinite density.<br><br>
        The purpose of them is to unlock Singularity Milestones, which are unique to Eternity Milestones. 
        Some of them can only be completed once, others can be done multiple 
        times for a stronger boost or a better Quality of Life.`,
    },
    {
        id: 36,
        name: 'Annihilation',
    ...
    },
    {
        ...
        you battle with Pelle (Armageddon) to gain the resources.<br><br>
